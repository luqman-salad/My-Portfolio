    ...
    <header className=" fixed w-full z-50">
      <div className="sm:bg-white sm:mt-3 sm:shadow sm:border sm:border-gray-300 sm:rounded-full max-w-3xl mx-auto px-4 py-2 flex justify-between items-center">
        ...
        <nav className="hidden sm:flex gap-6 items-center px-7">
          <Link href="/#about" className="hover:transition hover:text-cyan-700">About</Link>
          <Link href="/blog" className="hover:transition hover:text-cyan-700">Blog</Link>
          <Link href="/#contact" className="hover:transition hover:text-cyan-700">Contact</Link>
